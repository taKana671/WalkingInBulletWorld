...
from buildings import StoneHouse, BrickHouse, Terrace, Observatory, Bridge, Tunnel, AdventurePlayground
...
class Scene(NodePath):
    ...
    def make_buildings(self):
        ...
        buildings = [
            ...
            [AdventurePlayground, Point3(71, -5.2, -2), 0]
            # [GondolaLift, Point3(77.147, 39.3058, -3.48162), 0] 70, -15, -1.5
        ]
